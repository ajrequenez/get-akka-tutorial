...
namespace getakka_tutorial
{
	...
	{
        private ICancelable queryTimerTimout;
        ...
        public DeviceGroupQuery(Dictionary<IActorRef, string> actorToDeviceId, long requestId, IActorRef requester, TimeSpan timeout)
        {
            ...
            queryTimerTimout = Context.System.Scheduler.ScheduleTellOnceCancelable(timeout, Self, CollectionTimeout.Instance, Self);
